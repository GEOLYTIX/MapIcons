...
1. In the terminal in MapIcons, run cd png_to_svg_staging. This will put you into the png_to_svg_staging folder. 
2. Put all the png files (make sure png!) into png_to_svg_staging you wish to convert.
3. Run node png_to_svg.js in the terminal. 
